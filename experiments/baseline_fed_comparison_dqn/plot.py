...
def main():
    ...
    fig_l.suptitle("DQN/DQNAvg (Acrobot)", weight="bold", fontsize=14)
    fig_r, axs_r = plt.subplots(1,2)
    fig_r.set_size_inches(11, 4)
    fig_r.suptitle("DQN/DQNAvg (Acrobot)", weight="bold", fontsize=14)
    ...
    # Save figures
    fig_l.savefig(os.path.join(path,"federating_dqn_loss.png"), format="png", bbox_inches="tight")
    fig_l.savefig(os.path.join(path,"federating_dqn_loss.pdf"), format="pdf", bbox_inches="tight")
    fig_r.savefig(os.path.join(path,"federating_dqn_reward.png"), format="png", bbox_inches="tight")
    fig_r.savefig(os.path.join(path,"federating_dqn_reward.pdf"), format="pdf", bbox_inches="tight")
